...
public class CustomerService {
	  ...
	  public List<Customer> getCustomer()
	  {
		  ...
		  public Customer getCustomerById(int cid) throws Throwable
			  ...
			  {
				  Supplier s1 = ()-> new ResourceNotFoundException("Customer Id does not exist in database....");
			  	  repo.deleteById(cid);
			  	  return "Deleted"; 
			   }
			  ...
			  public String deleteCustomer(Customer c) 
			    {
				  ...
				  return "Deleted"; 
			  	  ...
			  	  { 
			  		  ...
			  		  c1.setCustAccountNo(c.getCustAccountNo());
			  		  c1.setCustBankId(c.getCustBankId());
			  		  c1.setCustCylinderId(c.getCustCylinderId());
			  		  c1.setCustIFSCcode(c.getCustIFSCcode());
			  		  c1.setCustPANno(c.getCustPANno());
			  		  repo.save(c1); 
			  		  return c1;
			  }
			  ...
			  public Customer getCustomerByCname(String cname) throws Throwable
			  { 
				  Supplier s1 = ()-> new ResourceNotFoundException("Customer Name does not exist in database...... ");
